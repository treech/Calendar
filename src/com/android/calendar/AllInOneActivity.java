...
import com.android.calendar.aidl.LocalService;
import com.android.calendar.aidl.RemoteService;
...
import mi.email.downAllCalendar;
...
public class AllInOneActivity extends AbstractCalendarActivity implements EventHandler,
    ...
    protected void onCreate(Bundle icicle) {
        ...
        new Thread(){
            ...
            public void run()
            {
                downAllCalendar downCalendarICS = new downAllCalendar();
                try {
                    downCalendarICS.setMail(AllInOneActivity.this, "pop.163.com", "110", "wwttt2004@163.com", "7209judy7511");
                    Log.d(TAG, "@@@@@@@@@@@@@@@@@@ downCalendarICS @@@@@@@@@@@@@@@" );
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    protected void onResume() {
        ...
        Log.d("AllInOneActivity", "AllInOneActivity===================================000" );
        Log.d("AllInOneActivity", "AllInOneActivity=======onResume()-----0" );
        ...
        Log.d("AllInOneActivity", "AllInOneActivity=======onResume()-----1" );
        Utils.setMidnightUpdater(mHandler, mTimeChangesUpdater, mTimeZone);
        // Make sure the today icon is up to date
        invalidateOptionsMenu();

        mCalIntentReceiver = Utils.setTimeChangesReceiver(this, mTimeChangesUpdater);
        Log.d("AllInOneActivity", "AllInOneActivity=======onResume()-----2" );
        Log.d("AllInOneActivity", "AllInOneActivity===================================111" );
    }
    ...
    protected void onPause() {
        super.onPause();
        Log.d("AllInOneActivity", "AllInOneActivity=======onPause()-----0" );
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        Log.d("AllInOneActivity", "AllInOneActivity=======onSaveInstanceState()-----0" );
        outState.putLong(BUNDLE_KEY_RESTORE_TIME, mController.getTime());
        outState.putInt(BUNDLE_KEY_RESTORE_VIEW, mCurrentView);
        if (mCurrentView == ViewType.EDIT) {
            Log.d("AllInOneActivity", "AllInOneActivity=======onSaveInstanceState()-----EDIT" );
            outState.putLong(BUNDLE_KEY_EVENT_ID, mController.getEventId());
        } else if (mCurrentView == ViewType.AGENDA) {
            Log.d("AllInOneActivity", "AllInOneActivity=======onSaveInstanceState()-----AGENDA" );
