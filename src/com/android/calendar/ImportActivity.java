...
public class ImportActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isValidIntent()) {
            ...
            Log.d("ImportActivity", "ImportActivity=======onCreate()" );
            parseCalFile();
        }
    }
    ...
    private void parseCalFile() {
        Log.d("ImportActivity", "ImportActivity=======parseCalFile()-----0" );
        ...
        Log.d("parseCalFile", "==========dtStart = " + dtStart);
        ...
        Log.d("parseCalFile", "==========dtEnd = " + dtEnd);
        ...
        try {
            Log.d("ImportActivity", "ImportActivity=======startActivity()-----0" );
            startActivity(calIntent);
            Log.d("ImportActivity", "ImportActivity=======startActivity()-----1" );
